  ...
  return (
      <>
          ...
          <section className='promo'>
            <img src={require('../../assets/images/products/xx59-promo-mobile-1.png')} className='rounded-lg md:order-3 md:w-full' alt="promo"/>
            <img src={require('../../assets/images/products/xx59-promo-mobile-2.png')} className='rounded-lg md:order-1 md:w-full' alt="promo"/>
            <img src={require('../../assets/images/products/xx59-promo-mobile-3.png')} className='rounded-lg md:order-2 md:row-span-2 md:w-full' alt="promo"/>
          </section>
          <section className='px-6 mb-[120px]'>
