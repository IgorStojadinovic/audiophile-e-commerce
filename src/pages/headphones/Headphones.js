      ...
      <section className='px-6 mb-[120px] md:px-10 xl:px-40  2xl:px-80'>
        <figure className='headphone-figure'>
          <picture className='headphone-picture'>
            ...
            />
            <img
              src={require('../../assets/images/heaphone-page/xx99-mark-II-mobile.png')}
              className='md:h-[200px] xl:h-[250px] 2xl:h-[300px]'
            />
          </picture>
          <figcaption className='headphone-fig-caption'>
            <p className='headphone-subheading'>new product</p>
            <h1 className='headphone-heading md:font-bold'>
        ...
        <figure className='headphone-figure'>
          <picture className='headphone-picture'>
            ...
            />
            <img
              src={require('../../assets/images/heaphone-page/xx-99-mark-I-mobile.png')}
              className='md:h-[200px] xl:h-[250px] 2xl:h-[300px]'
            />
          </picture>
          <figcaption className='headphone-fig-caption'>
        ...
        <figure className='headphone-figure'>
          <picture className='headphone-picture'>
            <img
              src={require('../../assets/images/heaphone-page/xx59-mobile.png')}
              className='md:h-[200px] xl:h-[250px] 2xl:h-[300px]'
            />
          </picture>
          <figcaption className='headphone-fig-caption'>
            <h1 className='headphone-heading w-1/2 md:w-[40%] md:font-bold'>
              XX59 headphones
            </h1>
            <p className='headphone-text'>
              As the gold standard for headphones, the classic XX99 Mark I
      ...
      <section className='products-sections'>
        <div className='product-wapper'>
          <div className='product-container'>
            <picture>
              <img
                className='2xl:h-[120px] xl:h-[120px] md:h-[100px]'
