...
const Footer = () => {
  ...
  return (
    <>
    {!isActiveCheckout && 
    <figure className='flex flex-col  justify-center  items-center rounded-lg mb-32 px-6 text-center mt-32 md:flex-col md:px-10 xl:flex-row-reverse'>
        <picture className='w-full xl:w-[30%]'>
          {/* Desktop image */}
          <source
        ...
        <figcaption className='xl:w-[50%] lg:[w-75%] lg:px-40 lg:text-left'>
    ...
    <footer className='bg-black flex flex-col justify-center items-center px-6 md:px-10  md:items-start'>
      ...
      <p className='text-white/50 text-center my-12 md:text-left'>
