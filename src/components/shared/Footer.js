...
const Footer = () => {
  ...
  return (
    <>
    {!isActiveCheckout && 
    <figure className='flex flex-col  justify-center  items-center rounded-lg mb-32 px-6 text-center mt-32 md:flex-col md:px-10 xl:flex-row-reverse xl:px-40 2xl:px-80'>
        ...
        <figcaption className='xl:w-[60%] lg:[w-75%] lg:px-40 lg:text-left xl:pl-0'>
    ...
    <footer className='bg-black flex flex-col justify-center items-center px-6 md:px-10  md:items-start xl:px-40 2xl:px-80 '>
